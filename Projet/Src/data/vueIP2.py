...
resultatIP2nc = NetCDFReader(FileName=['resultatIP2.nc'])
...
tempsAnimation = resultatIP2nc.TimestepValues

mon_fichier = open("fileIP2.kml", "w")
mon_fichier.close()
mon_fichier = open("fileIP2.kml", "a")
writeentete(mon_fichier)
for i, t in enumerate(tempsAnimation):
    renderView1.ViewTime = t
    dt_object = datetime.fromtimestamp(int(t))
    SaveScreenshot("IP2out" + str(i) + ".png")
